...
button_inline_1 = InlineKeyboardButton(text="Рассчитать норму калорий", callback_data="calories")
button_inline_2 = InlineKeyboardButton(text="Формулы расчета", callback_data="formulas")
kb_inline.add(button_inline_1, button_inline_2)
kb_inline_buy = InlineKeyboardMarkup(resize_keyboard=True)
button_inline_buy_1 = InlineKeyboardButton(text="Продукт1", callback_data="product_buying")
button_inline_buy_2 = InlineKeyboardButton(text="Продукт2", callback_data="product_buying")
button_inline_buy_3 = InlineKeyboardButton(text="Продукт3", callback_data="product_buying")
button_inline_buy_4 = InlineKeyboardButton(text="Продукт4", callback_data="product_buying")
kb_inline_buy.add(button_inline_buy_1, button_inline_buy_2, button_inline_buy_3, button_inline_buy_4)
